...
use crate::log::{log_errors, log_compile};
use std::fs;
use std::fs::File;
...
pub fn grader(student: &mut Student, homework_name: &str) -> Result<(), Box<dyn Error>> {
...
fn unzip_student_file(student: &Student, output_dir: &str) -> Result<(), Box<dyn Error>> {
...
fn run_make(student: &Student, homework_name: &str) -> Result<(), Box<dyn Error>> {
